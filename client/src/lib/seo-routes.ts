...
export const ROUTE_SEO = {
  home: {
    ...
    description:
      "We set businesses up with AI. Custom internal apps with an AI employee inside, AI consulting and AI training, from Galway for Irish businesses and Australian operations.",
    canonical: "/",
