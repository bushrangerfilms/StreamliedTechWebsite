      ...
      <section className="py-20" data-testid="section-cost">
        <div className="container mx-auto px-6">
          <div className="max-w-3xl mx-auto">
            ...
            <p className="text-lg text-muted-foreground mb-6">
              On the teaching side, the tools themselves can cost very little. Most of the ones your staff would use day to day are cheap or free, and the skill is in knowing what to hand them. That's what{" "}
              <Link href="/ai-training" className="text-primary underline hover:no-underline" data-testid="link-ai-training-cost">
                our AI training
              </Link>{" "}
              covers. It's built on your team's own work and kept current as the tools change.
            </p>
            <p className="text-lg text-muted-foreground mb-6">
